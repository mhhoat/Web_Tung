...
!(function (a, b, c, d) {
  ...
  (e.Defaults = {
    ...
    (e.prototype.initialize = function () {
      if (
        ...
        (a = this.$element.find("img")),
          ...
          a.length && c <= 0 && this.preloadAutoWidthimgs(a);
      }
    ...
    (e.prototype.preloadAutoWidthimgs = function (b) {
      b.each(
        a.proxy(function (b, c) {
...
!(function (i) {
  i.fn.parallax = function () {
    ...
    return this.each(function (t) {
      ...
      var r = i(this)
        .prepend(
          '<div class="material-parallax parallax"><img src="imgs/_blank.png" alt=""></div>'
        )
...
function multitoggles() {
  ...
  (t = {
    ...
    (e.prototype.init = function () {
      (this.selectorTarget = this.node.getAttribute(t.attrToggle)),
        (this.selectorGroup =
          "[" + t.attrToggle + '="' + this.selectorTarget + '"]'),
        (this.selectorBlur = this.node.getAttribute(t.attrBlur)),
        (this.isolate = this.node.hasAttribute(t.attrIsolate)),
    ...
    (e.prototype.checkBlurContain = function (t) {
      for (var e = !1, o = 0; o < this.nodesBlur.length; o++)
        e = this.nodesBlur[o].contains(t) || e;
      return e;
    }),
    (e.prototype.checkToggleTarget = function (e) {
      return (
        !e.hasAttribute(t.attrToggle) ||
        this.selectorTarget === e.getAttribute(t.attrToggle)
      );
    });
  for (
    var o = document.querySelectorAll("[" + t.attrToggle + "]"), r = [], l = 0;
    l < o.length;
    l++
  ) {
    var s = new e(o[l]);
  ...
  for (l = 0; l < r.length; l++)
    r[l].node.addEventListener(
      "click",
      (function (t) {
        return function () {
          for (var e = 0; e < t.nodesTarget.length; e++)
            t.nodesTarget[e].classList.toggle("active");
          for (e = 0; e < t.nodesGroup.length; e++)
            t.nodesGroup[e].classList.toggle("active");
        };
      })(r[l])
    ),
        ...
        (function (t) {
          return function () {
            if (t.selectorBlur && !t.checkBlurContain(event.target)) {
              for (var e = 0; e < t.nodesTarget.length; e++)
                t.nodesTarget[e].classList.remove("active");
              for (e = 0; e < t.nodesGroup.length; e++)
                t.nodesGroup[e].classList.remove("active");
            }
            if (t.isolate && !t.checkToggleTarget(event.target)) {
              for (e = 0; e < t.nodesTarget.length; e++)
                t.nodesTarget[e].classList.remove("active");
              for (e = 0; e < t.nodesGroup.length; e++)
                t.nodesGroup[e].classList.remove("active");
            }
